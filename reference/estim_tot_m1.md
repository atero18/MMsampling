...
Estimation of the total of the first mode of response potential outcomes
\\t_1\\.

## Usage

``` r
estim_tot_m1(Yobs, modes, pi, p1, phi = rep(1, length(Yobs)))
```
...
the estimation of the total \\t_1\\, possibly weighted (scalar).
