...
true_variance_tephi1 <- function(Y1exp, pi, covpMat, p1, phi, sd1 = 1.0)
{
  ...
  # S variability
    t(Y1exp * phi / pi) %*% (covpMat * Y1expMat) %*% (Y1exp * phi / pi) +
  # Y1 variability
    sum(phi^2L) * sd1^2L
}
```
...
true_variance_tephi2 <- function(Y2exp, pi, covpMat, p1, p2, phi, sd2 = 1.0)
{
  ...
  # S variability
    t(Y2exp * phi / pi) %*% (covpMat * Y2expMat) %*% (Y2exp * phi / pi) +
  # Y2 variability
    sum(phi^2L) * sd2^2L
}
```
...
```{r}
expData <- gen_expY(Z, betaInt, sdInt = 1.0, betaTel = betaTel, sdTel = 1.0)
## Attention : expYtels ici
true_variance_tephi1(expData$expYtels, pi, covar_SRS(n, N), pInt, phi, sd1 = 1.0)
true_variance_tephi2(expData$expYtels, pi, covar_SRS(n, N), pInt, pTel, phi, sd2 = 1.0)
rm(expData)
```
