                            ...
                            Y = NULL)
{
  ...
  monoSim <- function(...)
  {
    ...
    if (calcVariance)
    {
      ...
      apprVarPhiTW <- apprVarPhiSizeTW <- NA_real_
    ...
    if (calcVariance)
    {
      ...
      apprVarPhiEW <- apprVarPhiSizeEW <- NA_real_
