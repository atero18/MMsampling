                               ...
                               ...)
{
  ...
  for (stratum in unique(strata))
  {
    ...
    Y1Str <- Yobs[maskSampledStratum]
    Y2Str <- Yobs[maskSampledStratum]
    if (m1Only)
    {
      correctedY1Strp <- (samplingFractionStr * p1[maskResp1Str])^-1L * Y1Str
      # varpEst <-
      #   t(correctedY1Strp) %*%
      #   (covarpSr / piSr_mat) %*%
      #   correctedY1Strp %>%
    ...
    else if (m2Only)
    {
      ...
      correctedY2Strp <- 
        (pi[maskResp2Str] * (1.0 - p1[maskResp2Str]) * p2[maskResp2Str])^-1L * Y2Str
      # varpEst <-
      #   t(correctedY2Strp) %*%
      #   (covarpSmr / piSmr_mat) %*%
      #   correctedY2Strp %>%
