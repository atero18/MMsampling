...
for (chunk in seq_len(10000 / 500))
{
  ...
  aws.s3::s3write_using(
    resSimulation,
    FUN = saveRDS,
    object = glue("2025_07_01_{Msim}_1_to_{chunk}.rds"),
  ...
  aws.s3::s3write_using(
    seedEndChunk,
    FUN = write,
    object = glue("2025_07_01_{Msim}_seed_end_{chunk}.txt"),
    bucket = "ttassin/multimode/article_no_ME",
    opts = list("region" = "")
  )
}
