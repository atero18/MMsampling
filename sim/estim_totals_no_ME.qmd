...
ggplot(data) + 
  ...
  ggsave(p, file = "sim_age_cond_sexe.eps", device = "svg", units = "cm")
data %>% 
  group_by(sex) %>% 
...
#' Can be equal to NA for the units that are not in the subset defined by 
#' `maskSubset` (numeric vector of size N the size of the population).
